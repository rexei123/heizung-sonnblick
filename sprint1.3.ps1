...
Write-Host "=== Sprint 1.3 - PAT-Rotation auf heizung-test ===" -ForegroundColor Cyan
...
Write-Host "--- Test-Pull heizung-api:develop ---" -ForegroundColor Yellow
ssh @sshBase $sshTarget "docker pull ghcr.io/rexei123/heizung-api:develop"
Assert-ExitCode "docker pull heizung-api" $LASTEXITCODE

Write-Host "--- Test-Pull heizung-web:develop ---" -ForegroundColor Yellow
ssh @sshBase $sshTarget "docker pull ghcr.io/rexei123/heizung-web:develop"
...
Write-Host ""
Write-Host "=== Sprint 1.3 FERTIG ===" -ForegroundColor Green
Write-Host "Naechster Schritt: .\sprint1.4.ps1 (gleiche Rotation auf heizung-main)" -ForegroundColor Cyan
